...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " ncoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  ncoin-tx [options] <hex-tx> [commands]  Update hex-encoded ncoin transaction\n" +
            "or:     ncoin-tx [options] -create [commands]   Create hex-encoded ncoin transaction\n" +
            "\n";
