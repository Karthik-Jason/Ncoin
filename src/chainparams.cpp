...
public:
	...
	vSeeds.emplace_back("dnsseed.faithco.in", true);		
        /*vSeeds.emplace_back("seed-a.ncoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.ncointools.com");
        vSeeds.emplace_back("dnsseed.ncoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.ncointools.com");
        vSeeds.emplace_back("seed-b.ncoin.loshan.co.uk");
