# Support for Output Descriptors in Ncoin Core

Since Ncoin Core v0.17, there is support for Output Descriptors in the
...
on Ncoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Ncoin Core wallets, a convenience function `combo` is
