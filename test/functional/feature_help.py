...
"""Verify that starting ncoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ncoin with -h for help text")
        ...
        self.log.info("Start ncoin with -version for version information")
        ...
        self.log.info("Start ncoind with -fakearg to make sure it does not start")
