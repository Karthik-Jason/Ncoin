...
* ncoin.conf: contains configuration settings for ncoind or ncoin-qt
* ncoind.pid: stores the process id of ncoind while running
...
* debug.log: contains debug information and general logging generated by ncoind or ncoin-qt
